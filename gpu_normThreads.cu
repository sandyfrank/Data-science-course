...
extern "C"  void gpu_normThreads(double *Genes, double *Select, double *C, int *nA, int *N, int *M, int *K, int *R); 
...
void gpu_normThreads(double *Genes, double *Select, double *C, int *nA, int *N, int *M, int *K, int *R) 
{
  // Device Memory
...
//
// nvcc --ptxas-options=-v --compiler-options '-fPIC' -o gpu_normThreads.so --shared gpu_normThreads.cu
