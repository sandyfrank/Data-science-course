...
extern "C"  void gpu_norm10(double *Genes, double *Select, double *C, int *nA, int *N, int *M, int *K, int *R); 
...
void gpu_norm10(double *Genes, double *Select, double *C, int *nA, int *N, int *M, int *K, int *R) 
{
  // Device Memory
...
//
// nvcc --ptxas-options=-v --compiler-options '-fPIC' -o gpu_norm10.so --shared gpu_norm10.cu
